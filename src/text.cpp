...
int init_resources() {
	...
	//program = create_program("FontVertexShader.glsl", "FontFragmentShader.glsl");
	program = LoadShaders("FontVertexShader.glsl", "FontFragmentShader.glsl");
	if(program == 0)
		return 0;

	//attribute_coord = get_attrib(program, "coord");
	// TODO: put wrappers around getting the uniforms to check return vals.
	uniform_tex = glGetUniformLocation(program, "text");
